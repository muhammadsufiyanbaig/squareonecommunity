    ...
    <>
      <label className='themeSwitcherThree relative inline-flex cursor-pointer select-none items-center'>
        <input
          ...
          className='sr-only'
        />
        <div className='shadow-card flex h-[30px] w-[60px] items-center justify-center rounded-md bg-white'>
          <span
          ...
          <span
            className={`flex h-7 w-7 items-center justify-center rounded ${
              isChecked ? 'bg-zinc-900 text-white' : 'text-body-color'
            }`}
          >
            <svg
              width='16'
            ...
            >
              <path
                ...
                fill={isChecked ? '#ffffff' : 'currentColor'}
              ></path>
            </svg>
          </span>
        </div>
